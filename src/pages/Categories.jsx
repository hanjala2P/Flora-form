  ...
  return (
    <section className="py-20 bg-lime-50/50">
            ...
            >
              ...
              <div className="flex-grow mb-4">
                ...
                <div className="flex justify-between items-center mt-2">
                  <p className="font-bold text-lime-600 text-2xl">
                    ${cat.price}
                  </p>
      ...
      <div className="flex justify-center mt-12">
        ...
        >
          <button className="bg-lime-500 hover:bg-lime-600 text-white py-3 px-6 rounded-full font-bold transition-all shadow-md">
            All Plants
          </button>
        </Link>
      </div>
